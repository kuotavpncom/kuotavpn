...
sed -i '/#trojanupgrade$/a\### '"$user $expired_date TrojanUPGRADE-TLS "'\
,{"password": "'""$uuid""'","security": "'""auto""'","email": "'""$user""'"}' /usr/local/etc/xray/config.json
